function Resume({ data }) {
  ...
  return (
    <div
      className="relative h-200px space-y-6 p-3  flex flex-col pt-[569px] 
           md:pt-[1000px] md:p-40 bg-gradient-to-r from-indigo-200 via-purple-200 to-red-200 scrollbar-hide"
    >
