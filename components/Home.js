  ...
  return (
    ...
    >
      ...
      <div className="absolute space-y-4 top-40 w-full text-center ">
        <h1 className="md:text-8xl p-5 font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-r from-yellow-500 to-red-400 animate-pulse ">
          <TypeWriter typing={1}>{`I'm ${name}`}</TypeWriter>
        </h1>
        <h3 className=" p-2 md:text-xl font-bold text-gray-600">
